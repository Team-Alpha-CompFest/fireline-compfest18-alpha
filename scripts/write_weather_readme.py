...
readme_content = """# Laporan EDA: Data Cuaca dan Iklim Kalimantan (BMKG / ERA5)
...
output_path = 'EDA/02_bmkg_weather_kalimantan/README.md'
with open(output_path, 'w', encoding='utf-8') as f:
    f.write(readme_content.strip() + '\n')

print('README.md written successfully to:', output_path)
